...
<div class="container-fullwidth">
	<div class="row hidden-xs topper">
		<div class="col-xs-7 col-sm-7">
			<a href="header.jsp"><img am-TopLogo alt="SECUREVIEW"
				src="image/e.png" class="img-responsive"><span id="name">eBank24</span></a>
		</div>
	</div>
	<!-- End Topper -->
	<!-- Navigation -->
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							%>
							<li><a href="changepassword.jsp">Change Password<span
									class="glyphicon glyphicon-cog pull-right"></span></a></li>
									<li><a href="balance.jsp">Check Balance<span
									class="glyphicon glyphicon-cog pull-right"></span></a></li>
