<%@page import="com.green.bank.model.FixedDepositModel"%>
...
<title>fixed Deposit Process</title>
...
<body>
   ...
   String Not_Enough=null;
	FixedDepositModel model = new FixedDepositModel();%>

	<!-- Inserting account info into Database -->
	<%
		model = (FixedDepositModel) request.getAttribute("fixedDeposit");
	Not_Enough = (String) request.getAttribute("Not_Enough");
		if (Not_Enough==null) {
	%>
	...
	<div class="container-fullwidth">
		<div class="row" style="margin-top: 50px;">
			<div class="alert alert-success col-md-4 col-md-offset-4"
				...
				<p>
					<strong>Your fixed deposit has been granted.</strong>
				</p>
				<p class="mb-0">
					<b>Account Number: </b>
					<%=model.getAccount_no()%>
